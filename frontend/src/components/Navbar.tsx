          ...
          <div className="flex items-center gap-3">
            {user && (
              <>
                <Link
                  to="/profile"
                  className={`p-2 rounded-full hover:bg-fg/5 text-muted hover:text-fg transition-all flex items-center justify-center ${location.pathname === '/profile' ? 'text-teal bg-white/5' : ''}`}
                  title="Profilim"
                >
