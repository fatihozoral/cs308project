    ...
    <div className="min-h-screen bg-mesh flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 px-16 py-16 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2 text-xs text-muted">
          <span className="w-2 h-2 rounded-full bg-teal-DEFAULT animate-glow-pulse" />        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <button type="submit" disabled={loading}
                className="btn-gradient w-full px-6 py-3.5 text-sm font-bold flex items-center justify-center gap-2 disabled:opacity-60">
                {loading
              ...
              <Link to="/events" className="btn-ghost text-center w-full py-3.5 text-sm font-semibold text-muted hover:text-fg transition-colors">
